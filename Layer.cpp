...
void Layer::setlearningRate(int _w_learningRate, int _b_learningRate){
    for (int i=0; i<nNeurons; i++){
...
void Layer::setError(int _backwardError){
...
long Layer::getSumOutput(int _neuronIndex){
    return (neurons[_neuronIndex]->getSumOutput());
}

int Layer::getWeights(int _neuronIndex, int _weightIndex){
    return (neurons[_neuronIndex]->getWeights(_weightIndex));
}

int Layer::getInitWeight(int _neuronIndex, int _weightIndex){
    return (neurons[_neuronIndex]->getInitWeights(_weightIndex));
}

int Layer::getWeightChange(){
    weightChange=0;
    for (int i=0; i<nNeurons; i++){
...
int Layer::getWeightDistance(){
    return int(sqrt(weightChange));
}

int Layer::getOutput(int _neuronIndex){
